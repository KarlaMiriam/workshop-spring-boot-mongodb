package com.karla.workshopmongo.config;
...
import com.karla.workshopmongo.dto.AuthorDTO;
import com.karla.workshopmongo.dto.CommentDTO;
import com.karla.workshopmongo.repository.PostRepository;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c3 = new CommentDTO("Tenha um otimo dia!", sdf.parse("21/03/2020"), new AuthorDTO(alex));
